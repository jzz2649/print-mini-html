...
Or manually download and link printHTML.js in your HTML, It can also be downloaded via [UNPKG](https://unpkg.com/browse/print-mini-html@1.0.1/dist/):

```
<script src="https://unpkg.com/print-mini-html@1.0.1/dist/index.js"></script>
